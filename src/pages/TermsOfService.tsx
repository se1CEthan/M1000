            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                  ...
                  <li>Must provide valid cryptocurrency wallet address for payouts</li>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  configured cryptocurrency wallet address after successful transactions, subject to our payment terms.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Payments are processed through Cryptomus cryptocurrency payment gateway. Digital products are delivered immediately 
