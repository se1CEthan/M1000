...
import { Layout, Search, Filter, Grid, List, Code, Palette, FileText, Globe, Smartphone, Mail } from 'lucide-react';
...
const TEMPLATE_TYPES = [
  { id: 'website', label: 'Website Templates', icon: Globe, description: 'Complete website designs' },
  { id: 'mobile', label: 'Mobile UI Kits', icon: Smartphone, description: 'Mobile app templates' },
  { id: 'dashboard', label: 'Dashboard Templates', icon: Layout, description: 'Admin and analytics dashboards' },
  { id: 'landing', label: 'Landing Pages', icon: FileText, description: 'Marketing landing pages' },
  { id: 'email', label: 'Email Templates', icon: Mail, description: 'Email marketing templates' },
  { id: 'component', label: 'UI Components', icon: Palette, description: 'Reusable UI components' },
];
  ...
  return (
    <MainLayout>
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Beautiful, ready-to-use templates to jumpstart your projects
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Template Types */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4">Template Types</h2>
